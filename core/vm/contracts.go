...
var PrecompiledContractsOsaka = PrecompiledContracts{
	...
	common.BytesToAddress([]byte{0x1, 0x01}): &poseidon.Poseidon{},
	common.BytesToAddress([]byte{0x1, 0x02}): &add.BabyJubJubCurveAdd{},
	common.BytesToAddress([]byte{0x1, 0x03}): &mul.BabyJubJubCurveMul{},
	common.BytesToAddress([]byte{0x1, 0x04}): &validation.BabyJubJubCurveValidatePoint{},
	common.BytesToAddress([]byte{0x1, 0x05}): &eddsa.BabyJubJubCurveEdDSAVerify{},
	common.BytesToAddress([]byte{0x1, 0x06}): groth16.NewGroth16BN254Verify(),
}
